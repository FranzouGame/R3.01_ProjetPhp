...
(1, 'Henry', 'Découvrez Henry, laspirateur qui redéfinit le nettoyage. Conçu pour offrir une performance inégalée, Henry est le choix idéal pour les ménages et les professionnels en quête defficacité.', 'Images/images.jpg', '')
...
(3, 'MegaAspi3000x', 'Le MegaAspi3000x est le choix idéal pour ceux qui recherchent un aspirateur puissant, efficace et facile à utiliser. Que ce soit pour un nettoyage quotidien ou des tâches plus lourdes, il répondra à toutes vos attentes en matière de propreté.', 'Images/megaaspi3000x.jpg', '')